...
def map_team(team: FPLTeam) -> dict[str, object]:
    ...
    return {
        ...
        # before it has anything more specific to go on. FPL nulls out all
        # strength_* fields during preseason (before fixtures/results exist
        # to base a rating on), so fall back to a neutral mid-scale value
        # (FPL's strength scale typically runs ~1000-1400) until real data
        # is available.
        "strength_attack": team.strength_attack_home or 1000,
        "strength_defence": team.strength_defence_home or 1000,
    }
